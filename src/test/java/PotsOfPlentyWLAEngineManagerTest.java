...
public class PotsOfPlentyWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PotsOfPlentyWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PotsOfPlentyWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PotsOfPlentyWLAIW/InitOutcome.xml").getDocumentElement();
